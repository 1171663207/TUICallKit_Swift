...
@objc public class RecentCallsViewController: UIViewController {
    ...
    func activateConstraints() {
        containerView.snp.makeConstraints { make in
            ...
            make.height.equalTo(Screen.StatusBar_Height + 44)
        }
        segmentedControl.snp.makeConstraints { make in
            make.top.equalTo(containerView).offset(Screen.StatusBar_Height + 6.0)
        ...
        recordCallsList.snp.makeConstraints { make in
            make.top.equalTo(view).offset(Screen.StatusBar_Height + 44)
