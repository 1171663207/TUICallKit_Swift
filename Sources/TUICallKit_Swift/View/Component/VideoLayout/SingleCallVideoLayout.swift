...
private let kCallKitSingleSmallVideoViewFrame = CGRect(x: Screen.width - kCallKitSingleSmallVideoViewWidth,
                                                       y: Screen.StatusBar_Height + 40,
                                                       width: kCallKitSingleSmallVideoViewWidth,
                                                       height: kCallKitSingleSmallVideoViewWidth / 9.0 * 16.0)
private let kCallKitSingleLargeVideoViewFrame = CGRect(x: 0, y: 0, width: Screen.width, height: Screen.height)
