...
class CallMainView: UIView {
    ...
    private let functionView = FunctionView(frame: CGRect(x: 0, y: Screen.height - 220.scale375Height(), width: CGFloat(Int(375.scale375Width())), height: 220.scale375Height()))
    ...
    private func activateConstraints() {
        ...
        floatWindowButton.snp.makeConstraints { make in
            make.top.equalToSuperview().offset(Screen.StatusBar_Height + 12.scale375Height())
